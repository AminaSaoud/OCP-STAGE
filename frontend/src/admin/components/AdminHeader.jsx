...
const AdminHeader = ({ onToggleSidebar }) => {
  ...
  const notifications = [
    { id: 1, type: 'success', message: 'Nouveau collaborateur ajouté avec succès', time: 'Il y a 5 min', icon: '✓' },
    { id: 2, type: 'info', message: 'Mise à jour du système prévue', time: 'Il y a 1 heure', icon: '📦' },
    { id: 3, type: 'warning', message: 'Rappel: Inventaire prévu demain', time: 'Il y a 2 heures', icon: '⚠️' }
  ];

  const messages = [
    { id: 1, from: 'Admin OCP', subject: 'Mise à jour du système', time: 'Il y a 10 min', avatar: '👤' },
    { id: 2, from: 'Service IT', subject: 'Maintenance prévue', time: 'Il y a 1 heure', avatar: '🔧' }
  ];
