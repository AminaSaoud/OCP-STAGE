...
import { UserPlus, Building2, Calendar, Phone, Mail, User, CreditCard, Briefcase } from "lucide-react";
...
const AjouterCollaborateur = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axiosClient.post("/api/utilisateurs/collaborateur", formData);
      setMessage("Collaborateur ajouté avec succès ! Un email a été envoyé avec le mot de passe.");
      setForm({
        matricule: "",
        nom: "",
        prenom: "",
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h1 className="text-3xl font-bold mb-2">Nouveau Collaborateur</h1>
