...
import { Pencil, User, Mail, Phone, Building2, CreditCard, Calendar, UserPlus } from "lucide-react";
...
const ModifierControleurTechnique = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setMessage("Erreur lors du chargement du contrôleur technique.");
      } finally {
        setFetching(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage("Contrôleur technique modifié avec succès !");
      setTimeout(() => navigate("/admin/controleurs-technique"), 1200);
    } catch (err) {
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h1 className="text-3xl font-bold mb-2">Modifier Contrôleur Technique</h1>
...
export default ModifierControleurTechnique;