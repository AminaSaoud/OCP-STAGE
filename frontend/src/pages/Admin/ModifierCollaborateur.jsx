...
import { Pencil, User, Mail, Phone, Building2, Briefcase, CreditCard } from "lucide-react";
...
const ModifierCollaborateur = () => {
  ...
  useEffect(() => {
    const fetchCollaborateur = async () => {
      try {
        ...
        setMessage("Erreur lors du chargement du collaborateur.");
      } finally {
        setFetching(false);
      }
    };
  ...
  const validateForm = () => {
    ...
    // Validation date de prise de fonction
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/admin/collaborateurs"), 1200);
    } catch (err) {
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h1 className="text-3xl font-bold mb-2">Modifier Collaborateur</h1>
