...
import { UserPlus, Building2, Calendar, Phone, Mail, User, CreditCard } from "lucide-react";
...
const VERT_OCP_LIGHT = "#b4e197";
const VERT_OCP_DARK = "#2d5f2e";

const AjouterControleurMagasin = () => {
  ...
  // Validation du matricule (6 caractères)
  ...
  const handleChange = (e) => {
    ...
    if (name === 'nom' || name === 'prenom') {
      ...
      // Convertir en majuscules et limiter à 20 caractères
  ...
  const validateForm = () => {
    ...
    // Validation de la date de prise de fonction
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axiosClient.post("/api/utilisateurs/magasin", formData);
      setMessage("Contrôleur de magasin ajouté avec succès ! Un email a été envoyé avec le mot de passe.");
      setForm({
        matricule: "",
        nom: "",
        prenom: "",
      ...
      if (err.response?.data?.errors) {
        ...
        setMessage(err.response?.data?.message || "Erreur lors de l'ajout du contrôleur de magasin.");
      }
    } finally {
      setLoading(false);
    }
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h1 className="text-3xl font-bold mb-2">Nouveau Contrôleur de Magasin</h1>
                  ...
                  >
                    {loading ? (
                      ...
                      <span className="flex items-center">
                        ...
                        Ajouter le Contrôleur de Magasin
                      </span>
                    )}
                  </button>
                </div>
...
export default AjouterControleurMagasin;