...
const AjouterControleurTechnique = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axiosClient.post("/api/utilisateurs/technique", formData);
      setMessage("Contrôleur technique ajouté avec succès ! Un email a été envoyé avec le mot de passe.");
      setForm({
        matricule: "",
        nom: "",
        prenom: "",
      ...
      if (err.response?.data?.errors) {
        ...
        setMessage(err.response?.data?.message || "Erreur lors de l'ajout du contrôleur technique.");
      }
    } finally {
      setLoading(false);
    }
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                <div className="text-center">
                  ...
                  <h1 className="text-3xl font-bold mb-2">Nouveau Contrôleur Technique</h1>
                  ...
                  >
                    {loading ? (
                      ...
                      <span className="flex items-center">
                        ...
                        Ajouter le Contrôleur Technique
                      </span>
                    )}
                  </button>
                </div>
...
export default AjouterControleurTechnique; 